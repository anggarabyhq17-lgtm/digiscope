...
<body class="bg-darkBg text-gray-200 antialiased selection:bg-accent selection:text-white">
    ...
    <script>
        ...
        fetch('ambil-data.php')
            ...
            .then(data => {
                daftarArtikel = data;
                tampilkanHalaman(); // Jalankan tampilan SETELAH data berhasil ditarik
            })
            .catch(error => {
                console.error('Gagal mengambil data dari database:', error);
                gridContainer.innerHTML = `<div class="col-span-full py-12 text-center text-red-500 text-sm">Gagal memuat artikel dari server.</div>`;
            });
        ...
        function filterKategori(kategori) {
            ...
            tampilkanHalaman(); // <-- INI YANG SEBELUMNYA KURANG
        }
